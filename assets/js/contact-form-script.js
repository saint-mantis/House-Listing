! function(e) {
    ...
    e("#contactForm").validator().on("submit", function(n) {
        var s, i, o, m, r;
        n.isDefaultPrevented() ? (t(), a(!1, "Did you fill in the form properly?")) : (n.preventDefault(), s = e("#name").val(), i = e("#email").val(), o = e("#msg_subject").val(), m = e("#phone_number").val(), r = e("#message").val(), e.ajax({
            type: "POST",
